    ...
    Info({ Tex, style }) {
      return (
        <>
          ...
          <p>
            합성수를 소수의 곱으로 나타내는 방법을 말한다. 산술의 기본 정리에
            의해 모든 양의 정수는 소수의 곱으로 표현하는 방법이 (곱의 순서를
            바꾸는 것을 제외하면) 유일하게 존재한다. 그러나 산술의 기본정리는 그
          ...
          <p>
            ...
            알고리즘은 알려져 있지 않다. 단, 이론적인 양자컴퓨터에서의 다항식
            시간 소인수분해 알고리즘 (쇼어의 알고리즘)은 존재한다. 하지만
            아직까지 어떤 합성수를 다항 시간 안에 소인수분해하기는 어려운
            문제이며, 예를 들어 193자리 수(RSA-640)는 5개월간 30개의 2.2 GHz
            옵테론 CPU를 동원하여 소인수분해 되었다. 소인수분해의 난해함은 RSA와
            같은 현대 암호의 핵심적 부분이 된다.
          </p>
    ...
    Info: ({ style, Tex }) => (
      <>
        ...
        <p>
          ...
          <code
            className="block text-sm w-full p-6"
            style={{
